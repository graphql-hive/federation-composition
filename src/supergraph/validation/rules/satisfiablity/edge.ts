...
export function assertAbstractEdge(
  edge: Edge,
): asserts edge is Edge<AbstractMove> {
...
export class Edge<T = Move> {
  private resolvable: Array<
    [string[], OverrideLabels, EdgeResolvabilityResult]
  > = [];
