      ...
      () => {
        ...
        expect(result.supergraphSdl).toContainGraphQL(/* GraphQL */ `
          type User @join__type(graph: BAR, key: "id") @join__type(graph: FOO, key: "id") {
            id: ID
            name: String @join__field(graph: BAR, overrideLabel: "foo") @join__field(graph: FOO, override: "bar", overrideLabel: "foo")
          }
        `);
        ...
        result = composeServices([
          {
            ...
            type User @key(fields: "id") {
              id: ID
              name: String @override(from: "bar", label: "foo") @shareable
            }
          `),
          },
          {
        ...
        expect(result.supergraphSdl).toContainGraphQL(/* GraphQL */ `
          type User @join__type(graph: BAR, key: "id") @join__type(graph: BAZ, key: "id") @join__type(graph: FOO, key: "id") {
            id: ID
            name: String @join__field(graph: BAZ) @join__field(graph: BAR, overrideLabel: "foo") @join__field(graph: FOO, override: "bar", overrideLabel: "foo")
          }
        `);
    ...
    test('should detect unsatisfiable paths', () => {
      ...
      result = composeServices([{
        ...
        typeDefs: parse(/* GraphQL */ `
          ...
          type User @key(fields: "id") {
            id: ID!
            group: Group @override(from: "b", label: "foo")
          }
